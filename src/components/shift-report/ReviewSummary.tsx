          ...
          <table className="w-full">
            ...
            <tfoot>
              <tr className="border-t-2 border-gray-200 bg-gray-50/80">
                ...
                <td className="px-4 py-3" />
                <td className="px-4 py-3" />
                <td className="px-4 py-3 text-sm text-center font-bold text-gray-900">{valueStockTotal}</td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              {state.drawerStockEntries.map((entry) => (
                ...
                >
                  <td className="px-6 py-3 text-sm font-medium text-gray-700">{entry.drawer_number}</td>
